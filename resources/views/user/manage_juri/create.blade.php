    ...
    <div class="container text-start">
        ...
        <form action="{{ route('manageJuri.store') }}" method="POST" class="mb-5">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="exampleInputFullName" name="name" value="{{ old('name') }}" placeholder="Jhon Doe">
            </div>
            <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">AlamatEmail</label>
                <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                    name="email" value="{{ old('email') }}" placeholder="jhondoe@gmail.com">
            </div>
            <div class="mb-3">
